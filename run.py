...
def send_chat_email():
    ...
    # --- popraw wygląd tabel w mailach (inline) ---
    if "<table" in html_in:
        html_in = html_in.replace("<table", "<table style='border-collapse:collapse; width:100%; font-size:13px;' ")
        html_in = html_in.replace("<th", "<th style='border:1px solid rgba(255,255,255,0.25); padding:6px 8px; text-align:left; background:rgba(0,0,0,0.15);' ")
        html_in = html_in.replace("<td", "<td style='border:1px solid rgba(255,255,255,0.18); padding:6px 8px; vertical-align:top;' ")
        html_in = html_in.replace("<tr", "<tr style='border:0;' ")
      ...
      ">
        <div style="max-width:800px; margin:0 auto;">
          ...
          ">
            ...
            <!-- Footer dymku (bez flex - mail friendly) -->
            <div style="
              margin-top:10px;
              font-size:11px;
